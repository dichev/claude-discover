...
- `src/renderer/ui/` — generic primitives (`Toggle`, `EditableMarkdown`) plus `StatusBar` (footer showing the active Claude dir and capture-hook install state, with a tooltip).
